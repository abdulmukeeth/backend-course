...
initializeDatabase();
// 3. Create an API with route "/recipes1" to create a new recipe in the recipes database. Make sure to handle errors properly. Test your API with Postman. Add the following recipe:
...
app.post("/recipes1", async (req, res) =>{
    try{
...
app.get("/recipes1", async (req, res) => {
    try{
...
app.get("/recipes1/title/:title", async (req, res) => {
    try{
...
app.get("/recipes1/author/:author", async(req, res) => {
    try{
...
app.get("/recipes1/difficulty/:difficulty", async (req, res) => {
    try{
...
app.post("/recipes1/:id/difficulty", async (req, res) => {
    try{
...
app.post("/recipes1/updateTime/:title", async (req, res) => {
    try {
...
app.delete("/recipes1/:id", async (req, res) => {
    try{
        const recipeId = req.params.id;
